...
4. [캐릭터 일관성 필수] 주인공 아이(${name})는 모든 10개 페이지에서 반드시 "a small cute child with short black hair, round eyes, and rosy cheeks wearing cozy pajamas"로 동일하게 묘사해 주세요. 캐릭터의 외모 묘사가 페이지마다 절대 달라지면 안 됩니다.
